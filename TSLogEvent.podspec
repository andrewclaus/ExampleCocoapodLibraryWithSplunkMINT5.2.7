Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/andrewclaus/ExampleCocoapodLibraryWithSplunkMINT5.2.7"
  s.license          = 'MIT license'
  s.author           = { "Claus, Andrew" => "andrewclaus@amrock.com" }
  s.source           = { :git => "https://github.com/andrewclaus/ExampleCocoapodLibraryWithSplunkMINT5.2.7.git", :tag => s.version }
